...
export const REVIEWS_LOADING = 'search/REVIEWS_LOADING';
export const FRIENDS_LOADING = 'search/FRIENDS_LOADING';

export const FRIENDS_SEARCH = 'search/FRIENDS_SEARCH';
export const FRIENDS_SEARCH_ERROR = 'search/FRIENDS_SEARCH_ERROR';

export const REVIEWS_SEARCH = 'search/REVIEWS_SEARCH';
export const REVIEWS_SEARCH_ERROR = 'search/REVIEWS_SEARCH_ERROR';

export const PLACES_SEARCH = 'search/PLACES_SEARCH';
export const PLACES_SEARCH_ERROR = 'search/PLACES_SEARCH_ERROR';
